import pygame,os,sys,data,charMenu,start,transition
from pygame.locals import *
from charMenu import *

def playMario(screen):
    print 'Player chose Mario!'
    data.play_music('pickmario.wav',1,1)
    transition.TransitionScreen('Mario',screen)
    pass

def playLuigi(screen):
    print 'Player chose Luigi!'
    data.play_music('pickluigi.wav',1,1)
    transition.TransitionScreen('Luigi',screen)
    pass

def playToad(screen):
    print 'Player chose Toad!'
    data.play_music('picktoad.wav',1,1)
    transition.TransitionScreen('Toad',screen)
    pass

def playPokemonTrainer(screen):
    print 'Player chose Dinosaur!'
    data.play_music('pickyoshi.wav',1,1)
    transition.TransitionScreen('Yoshi',screen)
    pass
...
class Character():
    ...
    def __init__(self,screen):
        self.screen = screen
        self.title = pygame.transform.scale(data.load_image('select.jpg'),(640,460))
